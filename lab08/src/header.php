<?php
function theme_head($title='XSS Lab'){
  ...
  *{box-sizing:border-box} body{margin:0;background:var(--bg);color:#e5e7eb;font-family:system-ui,Segoe UI,Roboto}
  ...
  .nav a{color:#a5f3fc;text-decoration:none;margin-right:10px}
  .out{margin-top:14px;padding:12px;border:1px solid #263046;background:#0b1324;border-radius:12px;min-height:40px}
  </style></head><body>';
}
